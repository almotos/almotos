 ...
 * @version     0.2
 * 
 * Clase encargada de gestionar la información del listado de cargos de colaboradores existentes en el negocio para el proceso de la gestión de
 * recursos humanos. Este modulo es utilizado como relación por el modulo de empleados, y hará parte activa del modulo de gestión humana.
 *
 **/
...
class Cargo {
    ...
    /**
     * Código interno o identificador del cargo en la base de datos
     * @var entero
     */
    public $id;

    /**
     * URL relativa del módulo de cargos
     * @var cadena
     */
    public $urlBase;
    ...
    /**
     * Código interno del tipo de cargo
     * @var entero
     */
    public $nombre;
     ...
     *
     * @param entero $id Código interno o identificador de el cargo en la base de datos
     *
     */
 ...
 public function modificar($datos) {
     ...
     * Listar los objetos
     *
     * @param entero  $cantidad    Número de objetos a incluir en la lista (0 = todas las entradas)
