...
class SedeEmpresa {
    ...
    public function eliminar() {
        ...
        $arreglo4 = array('cajas',                           'id_sede     = "'.$this->id.'"', $textos->id('CAJAS'));//arreglo del que sale la info a consultar
        $arreglo5 = array('bodegas',                         'id_sede     = "'.$this->id.'"', $textos->id('BODEGAS'));//arreglo del que sale la info a consultar
        $arreglo6 = array('empleados',                       'id_sede     = "'.$this->id.'"', $textos->id('EMPLEADOS'));//arreglo del que sale la info a consultar
