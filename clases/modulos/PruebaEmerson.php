...
class PruebaEmerson {
    ...
    /**
     * Apellido del impuesto
     * @var entero
     */
    public $apellido;
   
     /**
     * Direccion del módulo de impuestos
     * @var cadena
     */
    public $direccion;
    /**
	...
	$datosItem['apellido']              = $datos['apellido'];
        $datosItem['direccion']             = $datos['direccion'];
	$datosItem['celular']               = $datos['celular'];
        $datosItem['aplica_clientes']       =  (isset($datos['aplica_clientes'])) ? '1' : '0';
        $datosItem['aplica_proveedores']    =  (isset($datos['aplica_proveedores'])) ? '1' : '0';
        $datosItem['activo']                =  (isset($datos['activo'])) ? '1' : '0';
        //$sql->depurar = true;
    ...
    public function generarTabla($arregloRegistros, $datosPaginacion = NULL) {
	    ...
	    HTML::parrafo($textos->id('APELLIDO'), 'centrado')              => 'apellido|i.apellido',
	    HTML::parrafo($textos->id('DIRECCION'), 'centrado')             => 'direccion|i.direccion',
            HTML::parrafo($textos->id('CELULAR'), 'centrado')               => 'celular|i.celular',
        ...
        return Recursos::generarTablaRegistros($arregloRegistros, $datosTabla, $ruta, $datosPaginacion) . HTML::crearMenuBotonDerecho('PRUEBAS_EMERSON');
    }
