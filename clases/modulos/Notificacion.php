 ...
 * @version     0.2
 * 
 * Clase encargada de gestionar la información del listado de notificaciones existentes en el sistema para un usuario determinado.
 * Esta clase permitirá agregar notificaciones o eventos a una determinada fecha, así mismo permitirá la modificación de dichas notificaciones
 * y generará alertas si estas notificaciones o eventos tienen recordatorios. Estas notificaciones serán usadas como un modulo independiente 
 * (como una especie de ajenda) y también funcionará haciendo uso de las notidficaciones que el sistema le genere a un usuario determinado, por
 * ejemplo el pago de alguna factura a un proveedor, el cobro a un cliente, o el vencimiento de la resolución de facturación vigente.
 * */
class Notificacion {
    ...
    /**
     * Código interno o identificador del usuario al que pertenece esta notificación
     * @var entero
     */
    public $idUsuario;
    ...
    /**
     * fecha de alerta de la notificación
     * @var entero
     */
    public $fechaAlerta;  
    
    /**
     * Tipo de la notificación 1=evento, 2=recordatorio, 3=alerta
     * @var entero
     */
    public $tipoNotificacion;    

    /**
     * Determina si esta notificación se encuentra o no activa
     * @var entero
     */
    public $activo;
