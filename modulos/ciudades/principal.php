...
$puedeEliminarMasivo = Perfil::verificarPermisosBoton('botonEliminarMasivoCiudades', $modulo->nombre);
$botonEliminar = '';
...
$botonesSuperiores          = HTML::contenedor($buscador . $botonAdicionar . $botonEliminar . $chkMarcarFilas . $campoNumRegistros . $campoNumRegistros . $contenedorNotificaciones, '', 'botonesSuperioresModulo');
