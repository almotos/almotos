...
$objeto     = new Accion(); /* creacion del objeto */
...
$campoNumRegistros .= HTML::campoTexto('cantidad_registros', 5, 5, $registros . ' ', 'soloNumerosEnter', 'campoNumeroRegistros', array('ruta' => '/ajax/acciones/move'), $textos->id('AYUDA_SELECCIONAR_CANTIDAD_REGISTROS'));
