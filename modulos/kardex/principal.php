...
$objeto         = new Kardex(); /* creacion del objeto */
...
$botonBuscador              = HTML::contenedor('', 'botonBuscador', 'botonBuscador', array('alt' => HTML::urlInterna($modulo->nombre, 0, true, 'search'), 'ayuda' => $textos->id('BUSCAR_ITEM')));
$buscador                   = HTML::campoTexto('datos[patron]', 50, '', '', 'campoBuscador margenIzquierdaDoble', 'campoBuscador') . $botonRestaurar . $botonBuscador;
...
$botonesSuperiores          = HTML::contenedor($buscador . $campoNumRegistros . $contenedorNotificaciones, '', 'botonesSuperioresModulo');
