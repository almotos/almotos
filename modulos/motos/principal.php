...
$objeto             = new Moto(); /* creacion del objeto */

$excluidas          = array('0', '999'); //items excluidos en la consulta
$item               = '';
...
$puedeEliminarMasivo = Perfil::verificarPermisosBoton('botonEliminarMasivoMotos', $modulo->nombre);
$botonEliminar = '';
