...
$objeto         = new Perfil(); /* creacion del objeto */
...
$botonesSuperiores          = HTML::contenedor($buscador . $botonAdicionar . $chkMarcarFilas . $campoNumRegistros . $contenedorNotificaciones, '', 'botonesSuperioresModulo');
