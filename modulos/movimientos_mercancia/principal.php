...
$objeto = new MovimientoMercancia(); /* creacion del objeto */
...
$botonesSuperiores = HTML::contenedor($buscador . $chkMarcarFilas . $campoNumRegistros . $contenedorNotificaciones, '', 'botonesSuperioresModulo');
