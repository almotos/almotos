...
$objeto         = new CambioInventario(); /* creacion del objeto */
...
$botonesSuperiores          = HTML::contenedor($buscador . $botonImprimirBarcodePdf . $chkMarcarFilas . $campoNumRegistros . $contenedorNotificaciones, '', 'botonesSuperioresModulo');
